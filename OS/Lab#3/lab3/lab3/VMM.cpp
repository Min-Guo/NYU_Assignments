...
void FIFOMapping::printTable(Instruction instruction, int a, int sameState){
...
void FIFOMapping::printMap(int inputLine, Instruction instruction, int oldPage, int oldPhy, int sameState){
    if (sameState == 1) {
        cout<< "==> inst: " << instruction.operation << " "<<instruction.virtualPageIndex <<endl;
    }else {
        cout<< "==> inst: " << instruction.operation << " "<<instruction.virtualPageIndex <<endl;
...
void LRUMapping::printTable(Instruction instruction, int a, int sameState){
    cout<<"==> inst: "<<instruction.operation << " "<<instruction.virtualPageIndex<<endl;
    if (sameState == 0) {
        printf("%d: ZERO       %2d\n", a, physicalFrameNumber(instruction.virtualPageIndex));
        printf("%d: MAP    %2d  %2d\n", a, instruction.virtualPageIndex, physicalFrameNumber(instruction.virtualPageIndex));
...
bool LRUMapping::sameVaildPage(int a, int b, Instruction instruction, int sameState){
    for (int i = 0; i < b; i++) {
...
void ClockMapping::printTable(Instruction instruction, int a, int sameState){
    cout<<"==> inst: "<<instruction.operation << " "<<instruction.virtualPageIndex<<endl;
    if (sameState == 0) {
        printf("%d: ZERO       %2d\n", a, physicalFrameNumber(instruction.virtualPageIndex));
        printf("%d: MAP    %2d  %2d\n", a, instruction.virtualPageIndex, physicalFrameNumber(instruction.virtualPageIndex));
...
void ClockMapping::printMap(int inputLine, Instruction instruction, int oldPage, int oldPhy, int sameState){
    if (sameState == 1) {
        cout<< "==> inst: " << instruction.operation << " "<<instruction.virtualPageIndex <<endl;
    }else {
        cout<< "==> inst: " << instruction.operation << " "<<instruction.virtualPageIndex <<endl;
...
void SecondChanceMapping::printTable(Instruction instruction, int a, int sameState){
    cout<<"==> inst: "<<instruction.operation << " "<<instruction.virtualPageIndex<<endl;
    if (sameState == 0) {
        printf("%d: ZERO       %2d\n", a, physicalFrameNumber(instruction.virtualPageIndex));
        printf("%d: MAP    %2d  %2d\n", a, instruction.virtualPageIndex, physicalFrameNumber(instruction.virtualPageIndex));
...
void SecondChanceMapping::printMap(int inputLine, Instruction instruction, int oldPage, int oldPhy, int sameState){
    if (sameState == 1) {
        cout<< "==> inst: " << instruction.operation << " "<<instruction.virtualPageIndex <<endl;
    }else {
        cout<< "==> inst: " << instruction.operation << " "<<instruction.virtualPageIndex <<endl;
...
void RandomMapping::printTable(Instruction instruction, int a, int sameState){
    cout<<"==> inst: "<<instruction.operation << " "<<instruction.virtualPageIndex<<endl;
    if (sameState == 0) {
        printf("%d: ZERO       %2d\n", a, physicalFrameNumber(instruction.virtualPageIndex));
        printf("%d: MAP    %2d  %2d\n", a, instruction.virtualPageIndex, physicalFrameNumber(instruction.virtualPageIndex));
...
void RandomMapping::printMap(int inputLine, Instruction instruction, int oldPage, int oldPhy, int sameState){
    if (sameState == 1) {
        cout<< "==> inst: " << instruction.operation << " "<<instruction.virtualPageIndex <<endl;
    }else {
        cout<< "==> inst: " << instruction.operation << " "<<instruction.virtualPageIndex <<endl;
