...
int main(int argc, const char * argv[]) {
    ...
    file = fopen("/Users/Min/Development/NYU_Assignments/OS/Lab#2/lab2_assign/rfile", "r");
    readRandNum(file);
    fclose(file);
    Scheduler scheduler;
    file = fopen("/Users/Min/Development/NYU_Assignments/OS/Lab#2/lab2_assign/input6", "r");
